...
st.markdown(f"""<style>
    .stApp {{background-color: #1f1f1f !important;color: #ffffff !important;}}
    ...
    section[data-testid="stSidebar"] a:hover {{background-color: #1f1f1f !important;transition: all 0.3s ease;border-radius: 5px;padding: 5px 10px;text-decoration: none;}}
...
pg = st.navigation({"NAVIGATION": [main_page, contact],
