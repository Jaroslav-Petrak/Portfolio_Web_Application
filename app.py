...
airbnb_etl_database_report_and_recommendation_system = st.Page(page = "web_pages/airbnb_etl_database_report_and_recommendation_system.py", title = "Bangkok AirBnB (IN DEVELOPMENT)")
